# Cronograma diário de preparação — AWS SAA-C03

**Período:** 25/07/2026 a 31/08/2026  
**Carga:** 3 horas líquidas por dia, de segunda a sábado  
**Descanso:** todos os domingos, sem aulas, questões ou revisões  
**Carga total disponível:** 32 dias de estudo × 3 horas = **96 horas**  
**Perfil considerado:** iniciante absoluto em AWS, sem experiência profissional na plataforma  
**Recursos disponíveis:** conta AWS e pequeno orçamento mensal para laboratórios  
**Idioma do exame:** inglês  
**Janela pretendida para a prova:** depois de 01/09/2026, ainda sem data marcada

---

## 1. Resultado do planejamento

O período comporta exatamente 96 horas líquidas, dentro da faixa de 88 a 102 horas definida no Plano Mestre. O plano reserva:

| Atividade | Carga |
|---|---:|
| Curso da Udemy, usando as durações consolidadas das 33 seções | 27 h 14 min |
| Guia, teoria e recuperação ativa D+2/D+7 | 20 h |
| Laboratórios e exercícios de arquitetura | 16 h |
| Quizzes, questões e correções aprofundadas | 23 h 46 min |
| Três simulados finais completos, com 65 questões | 9 h |
| **Total** | **96 h** |
...
- **SIM:** simulado completo, cronometrado e sem consulta.

Cada linha diária soma exatamente **180 minutos**. Intervalos, carregamento de serviços, pausas e organização do ambiente não contam como tempo líquido.

As durações de vídeo usam o total mostrado no cabeçalho de cada seção do HTML. A soma dos minutos arredondados mostrados em cada aula é aproximadamente 15 minutos maior; essa diferença é causada pelo arredondamento da interface. Para controle de carga, vale o total consolidado de **27 h 14 min**.
...
## 3. Inventário do curso usado no cálculo

| Seção | Tema resumido | Aulas/itens | Vídeo | Datas |
|---:|---|---|---:|---|
| 1 | Introduction | aulas 1–6 | 15 min | 25/07 |
| 2 | Code & Slides Download | aula 7 | 1 min | 25/07 |
| 3 | Getting Started with AWS | aulas 8–10 | 13 min | 25/07 |
| 4 | IAM & AWS CLI | aulas 11–30 + quiz | 57 min | 25 e 27/07 |
| 5 | EC2 Fundamentals | aulas 31–46 + quiz | 1 h 38 min | 27 e 28/07 |
| 6 | EC2 — SAA Level | aulas 47–55 + quiz | 34 min | 29/07 |
| 7 | EC2 Instance Storage | aulas 56–69 + quiz | 59 min | 29 e 30/07 |
| 8 | ELB & Auto Scaling | aulas 70–86 + quiz | 1 h 34 min | 30/07 a 01/08 |
| 9 | RDS, Aurora & ElastiCache | aulas 87–100 + quiz | 1 h 10 min | 03/08 |
| 10 | Route 53 | aulas 101–120 + quiz | 1 h 25 min | 04 e 05/08 |
| 11 | Classic Architectures | aulas 121–127 + quiz | 43 min | 05/08 |
| 12 | S3 Introduction | aulas 128–141 + quiz | 50 min | 06/08 |
| 13 | Advanced S3 | aulas 142–149 + quiz | 30 min | 06/08 |
| 14 | S3 Security | aulas 150–164 + quiz | 53 min | 07/08 |
| 15 | CloudFront & Global Accelerator | aulas 165–171 + quiz | 33 min | 07/08 |
| 16 | Storage Extras | aulas 172–181 + quiz | 37 min | 08/08 |
| 17 | SQS, SNS, Kinesis & MQ | aulas 182–197 + quiz | 1 h 21 min | 10 e 11/08 |
| 18 | ECS, Fargate, ECR & EKS | aulas 198–207 + quiz | 49 min | 11 e 12/08 |
| 19 | Serverless | aulas 208–225 + quiz | 1 h 23 min | 12 e 13/08 |
| 20 | Serverless Architectures | aulas 226–229 + quiz | 16 min | 14/08 |
| 21 | Databases in AWS | aulas 230–239 + quiz | 25 min | 14/08 |
| 22 | Data & Analytics | aulas 240–251 + quiz | 48 min | 14 e 15/08 |
| 23 | Machine Learning | aulas 252–263 + quiz | 26 min | 15/08 |
| 24 | Monitoring & Audit | aulas 264–281 + quiz | 1 h 19 min | 17/08 |
| 25 | Advanced IAM | aulas 282–291 + quiz | 49 min | 17 e 18/08 |
| 26 | Security & Encryption | aulas 292–312 + quiz | 1 h 26 min | 18 e 19/08 |
| 27 | VPC & Networking | aulas 313–350 + quiz | 2 h 40 min | 19 a 21/08 |
| 28 | DR & Migrations | aulas 351–361 + quiz | 44 min | 21/08 |
| 29 | More Architectures | aulas 362–366 + quiz | 27 min | 21/08 |
| 30 | Other Services | aulas 367–381 + quiz | 48 min | 22/08 |
| 31 | Well-Architected | aulas 382–385 + quiz | 15 min | 22/08 |
| 32 | Exam Preparation | aulas 386–393 + simulado | 17 min | vídeos em 22/08; simulado em 28/08 |
| 33 | Conclusion | aulas 394–396 | 9 min | 22/08 |
|  | **Total de vídeo** | **396 aulas numeradas** | **27 h 14 min** |  |

---

## 4. Regra das revisões D+2 e D+7

Cada dia de conteúdo recebe um código `B01` a `B25`. A revisão deve recuperar o conteúdo sem reler primeiro:

1. explicar o tema em voz alta;
2. responder de cinco a oito perguntas curtas;
3. completar uma comparação ou reconstruir uma arquitetura;
4. reabrir erros e respostas de baixa confiança;
5. consultar o Guia somente depois da tentativa.

Cada bloco requer aproximadamente 5 a 10 minutos por revisão. Quando mais de um bloco vence no mesmo dia, o tempo combinado já está dentro de **T**.

Se D+2 cair no domingo, a revisão passa para a segunda-feira seguinte. Isso ocorre somente com B06, B12, B18 e B24. A revisão atrasada é explicitamente identificada no cronograma. D+7 sempre cai no mesmo dia da semana e, portanto, não exige estudo no domingo.

---

## 5. Cronograma diário detalhado

### Semana 1 — fundamentos, IAM, EC2, armazenamento e alta disponibilidade
...
- **Material:** [capítulo B01](../03_Guia_do_Estudante/Capitulos/B01_Infraestrutura_Global_Responsabilidade_e_IAM.md),
  ...
  [controle de revisões](../06_Progresso/B01_Checklist_e_Revisoes.md).
- **V — 63 min:** seções 1–3 e seção 4, aulas 11–18. Introdução, infraestrutura global, console, IAM, MFA, access keys, CLI e SDK.
- **T — 50 min:** Regions, Availability Zones, edge locations, responsabilidade compartilhada, identidade, autenticação, autorização, users, groups, policies e roles. Iniciar glossário inglês-português.
- **L — 35 min:** proteger a conta: MFA no root, conferir contatos, ativar alertas de cobrança e criar o orçamento mensal. Não criar access key para o root. Verificar a identidade usada no console.
- **Q — 32 min:** 6–8 questões fundamentais de nuvem e IAM; corrigir todas e abrir o Caderno de Erros.
- **Revisões:** nenhuma.
- **Saída do dia:** explicar sem consulta por que uma Region tem várias AZs e por que workloads não devem usar o usuário root.
...
- **Revisões:** D+2 de B01.
- **Saída do dia:** distinguir user, role, policy e access key em um cenário.
...
- **Revisões:** nenhuma.
- **Saída do dia:** justificar On-Demand versus Savings Plans/Reserved versus Spot.
...
- **Revisões:** D+2 de B02.
- **Saída do dia:** escolher a placement strategy, prever quando o endereço muda e recuperar EBS em outra AZ.
...
- **L — 50 min:** desenhar uma aplicação em duas AZs com ALB e target groups. Fazer walkthrough do console sem criar load balancer, salvo se o preço por hora e o orçamento tiverem sido confirmados.
- **Q — 44 min:** 8–10 questões de ELB e disponibilidade.
- **Revisões:** D+2 de B04.
- **Saída do dia:** comparar ALB, NLB e GWLB por protocolo e requisito.
...
- **Revisões:** D+2 de B05 e D+7 de B01.
- **Saída do dia:** registrar taxa de acerto semanal e três lacunas prioritárias.

**02/08 — domingo: descanso integral.**

### Semana 2 — bancos, DNS, S3, entrega global e armazenamento híbrido
...
- **Revisões:** D+2 atrasado de B06, D+2 de B07 e D+7 de B02.
...
- **L — 40 min:** observar resolução com `nslookup`/`dig` e resolver cenários de roteamento. Não registrar domínio nem criar hosted zone sem aceitar explicitamente o custo recorrente.
- **Q — 44 min:** 8–10 questões de Route 53.
- **Revisões:** D+7 de B03.
- **Saída do dia:** criar mapa Alias versus CNAME e simple/weighted/latency.
...
- **Revisões:** D+2 de B08 e D+7 de B04.
- **Saída do dia:** justificar política de roteamento para quatro cenários.
...
- **Revisões:** D+2 de B09 e D+7 de B05.
- **Saída do dia:** selecionar storage class por frequência, tempo de recuperação e custo.
...
- **Revisões:** D+2 de B10 e D+7 de B06.
- **Saída do dia:** comparar CloudFront e Global Accelerator e escolher método de encryption.
...
- **Revisões:** D+2 de B11 e D+7 de B07.
- **Saída do dia:** registrar erros recorrentes por segurança, resiliência, desempenho, custo e operação.

**09/08 — domingo: descanso integral.**

### Semana 3 — mensageria, contêineres, serverless, bancos e analytics
...
- **Q — 46 min:** 8–10 questões de SQS/SNS.
- **Revisões:** D+2 atrasado de B12, D+2 de B13 e D+7 de B08.
- **Saída do dia:** escolher Standard, FIFO, SNS ou combinação SNS+SQS.
...
- **Revisões:** D+7 de B09.
- **Saída do dia:** justificar mensageria pela necessidade de replay, ordering, fan-out e compatibilidade.
...
- **Revisões:** D+2 de B14 e D+7 de B10.
- **Saída do dia:** decidir entre EC2, ECS/Fargate, EKS e Lambda.
...
- **Revisões:** D+2 de B15 e D+7 de B11.
- **Saída do dia:** explicar quando API Gateway + Lambda + DynamoDB reduz operação.
...
- **Revisões:** D+2 de B16 e D+7 de B12.
- **Saída do dia:** escolher banco por estrutura, escala, latência e consistência.
...
- **Revisões:** D+2 de B17 e D+7 de B13.
- **Saída do dia:** reconhecer o serviço de analytics correto sem memorizar detalhes fora do escopo.

**16/08 — domingo: descanso integral.**

### Semana 4 — observabilidade, segurança, VPC, DR, custos e fechamento do curso
...
- **Revisões:** D+2 atrasado de B18, D+2 de B19 e D+7 de B14.
- **Saída do dia:** comparar CloudWatch, CloudTrail e Config.
...
- **Revisões:** D+7 de B15.
- **Saída do dia:** resolver uma cadeia de autorização e justificar KMS versus Parameter Store.
...
- **Revisões:** D+2 de B20 e D+7 de B16.
...
- **L — 25 min:** ampliar o desenho VPC com endpoints e conectividade híbrida; simular tabelas de rotas. NAT Gateway, interface endpoint, Site-to-Site VPN e Direct Connect ficam somente em arquitetura.
- **Q — 38 min:** aproximadamente 8 questões de VPC.
- **Revisões:** D+2 de B21 e D+7 de B17.
- **Saída do dia:** traçar o caminho completo de um pacote e localizar o ponto de bloqueio.
...
- **Revisões:** D+2 de B22 e D+7 de B18.
...
- **L — 10 min:** auditoria de cleanup e cobrança da conta. Se houver stack de laboratório, excluir a stack e confirmar que recursos dependentes desapareceram.
- **Q — 51 min:** concluir quizzes 28/29, quizzes das seções 30/31 e checkpoint do fim do curso.
- **Revisões:** D+2 de B23 e D+7 de B19.
- **Saída do dia:** curso concluído, matriz marcada e nenhuma pendência de recurso AWS.

**23/08 — domingo: descanso integral.**

### Semana final — consolidação, correção e simulados
...
- **Revisões:** D+2 de B24/B25 e D+7 de B20.
...
- **Q — 60 min:** 20–25 questões inéditas, 100% em inglês, com ênfase em performance e custo.
- **Revisões:** D+7 de B21.
- **Saída do dia:** nenhuma lacuna crítica desconhecida antes do SIM A.
...
- **Q — 100 min:** correção aprofundada do SIM A, análise de todas as alternativas, atualização do Caderno de Erros e 10–15 questões direcionadas às duas maiores lacunas.
- **Revisões:** D+7 de B23.
...
- **Saída do dia:** decisão documentada sobre marcar ou adiar a prova.

---

## 6. Progressão para a prova em inglês

O material teórico continua em português, mas nomes oficiais, diagramas, palavras decisivas e alternativas permanecem em inglês.

| Período | Proporção mínima das questões em inglês |
|---|---:|
| 25/07 a 01/08 | 30–40% |
| 03/08 a 08/08 | 50–60% |
| 10/08 a 15/08 | 75% |
...
O glossário deve priorizar expressões que mudam a decisão, como:
...
- *read-heavy*;
- *write-heavy*;
- *multi-Region* e *multi-AZ*.

Não traduzir mentalmente a questão inteira. Localizar primeiro requisito obrigatório, restrições e palavras decisivas.

---

## 7. Política obrigatória de custos e segurança dos laboratórios

### Antes de criar

1. Usar primeiro Free Tier ou exercício em diagrama.
2. Manter os laboratórios em uma única Region, salvo quando o tema exigir multi-Region.
3. Confirmar no console e na página de preços se a conta ainda é elegível ao Free Tier.
4. Estimar o custo e comparar com o teto mensal antes de clicar em **Create**.
5. Criar tags como `Project=SAA-C03-Lab`, `Owner=Study` e `DeleteBy=AAAA-MM-DD`.
6. Configurar alertas do orçamento em 50%, 80% e 100% do teto mensal escolhido.
7. Nunca usar o usuário root em laboratório e nunca inserir access keys em código ou notas.

### Serviços que devem ficar em diagrama por padrão

Não criar apenas para “ver funcionando” sem aprovação consciente de custo:
...
- OpenSearch;
- ElastiCache;
- Aurora ou RDS Multi-AZ;
- FSx;
- Site-to-Site VPN;
- WAF;
- Direct Connect;
- ambientes completos Elastic Beanstalk com load balancer;
- estruturas multi-Region duplicadas.

### Cleanup obrigatório

Todo laboratório termina dentro do seu bloco **L**. “Parar” não substitui “excluir” quando o recurso continua cobrando.

Conferir, conforme o laboratório:

- terminar EC2 e excluir volumes EBS, snapshots, AMIs e Elastic IPs não associados;
- excluir load balancers, target groups, Auto Scaling Groups e launch templates;
- excluir NAT Gateways e VPC endpoints pagos;
- excluir bancos, clusters e snapshots automáticos/finais não necessários;
- esvaziar buckets versionados, incluindo versões e delete markers, antes de excluí-los;
- excluir EFS/FSx e mount targets;
- excluir filas, tópicos, streams e subscriptions;
- excluir APIs, stages, functions, tables e CloudWatch log groups;
- excluir stacks CloudFormation e verificar recursos retidos;
- conferir Billing/Cost Explorer no dia seguinte, considerando que os dados podem ter atraso.

Se o cleanup não foi verificado, o laboratório não está concluído.

---

## 8. Rotina obrigatória de questões e Caderno de Erros

Durante as três primeiras semanas, qualidade tem prioridade sobre volume:

- Semana 1: aproximadamente 6–10 questões por dia;
- Semana 2: aproximadamente 8–12 questões por dia;
- Semana 3: aproximadamente 10–15 questões por dia;
- Semana 4: aproximadamente 12–18 questões por dia;
- consolidação: 20–25 questões direcionadas por sessão.

Toda resposta errada ou correta com baixa confiança deve registrar:

1. tópico e domínio;
2. alternativa escolhida e resposta correta;
3. requisito central e palavra decisiva;
4. causa do erro;
5. regra de decisão reutilizável;
6. ação corretiva;
7. data D+2 e D+7;
8. resultado da recuperação.

O tempo **Q** inclui a correção. Encerrar um bloco apenas com a porcentagem de acerto não conta como estudo concluído.

---

## 9. Critério diário de conclusão

Um dia só deve ser marcado como concluído quando houver:

- vídeos e quiz previstos finalizados;
- síntese de cinco a dez pontos em palavras próprias;
- comparação ou regra arquitetural registrada;
- laboratório validado ou arquitetura desenhada;
- cleanup confirmado;
- questões corrigidas;
- erros/incertezas registrados;
- revisões D+2/D+7 do dia executadas.

Se faltar tempo, cortar primeiro quantidade de questões adicionais, nunca cleanup, correção, revisão vencida ou conceito essencial. A pendência deve ser incorporada ao bloco Q do próximo dia sem ultrapassar as três horas; se isso ocorrer repetidamente, reduzir a velocidade de avanço e usar 31/08 como diagnóstico, não como justificativa para marcar a prova.

---

## 10. Critério para marcar a prova depois de 01/09

Marcar a prova somente se, ao encerrar 31/08:

- a matriz de cobertura estiver completa;
- pelo menos dois dos três simulados inéditos tiverem **80% ou mais**;
- os simulados tiverem sido concluídos dentro de 130 minutos;
- não houver lacuna crítica em IAM/security, VPC, storage, databases, resilience ou cost optimization;
- os quatro domínios estiverem estáveis;
- o estudante conseguir justificar respostas, e não apenas reconhecer alternativas;
- não houver erro conceitual aberto no Caderno de Erros.

Se o critério não for atendido, adiar a prova é a decisão correta. Usar os resultados do SIM C para montar uma extensão curta e dirigida, em vez de repetir o curso inteiro.
